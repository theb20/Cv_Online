...
const Footer = () => {
  ...
  return (
    <footer
      id="footer"
      className="relative from-transparent via-neutral-950 w-screen "
    >
      ...
      <section className="relative flex flex-col gap-8 items-center justify-between pb-8 pt-16 text-neutral-400 c-space">
        ...
        >
          <h3 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-gradient-x">
            Frédérick Ahobaut
          </h3>
